...
public class IslandCommand extends CompositeCommand {
    ...
    /* (non-Javadoc)
     * @see us.tastybento.oneblock.api.commands.CompositeCommand#setup()
     */
    @Override
    public void setup() {
    ...
    /* (non-Javadoc)
     * @see us.tastybento.oneblock.api.commands.CommandArgument#execute(org.bukkit.command.CommandSender, java.lang.String[])
     */
    @Override
